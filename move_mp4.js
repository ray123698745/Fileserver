...
var newArrived = path.newArrived + 'R/';
...
fs.readdir(newArrived, function(err, seqs) {
    ...
    if (!err) {
        ...
        seqs.forEach(function(seq){
            ...
            if (seq.charAt(0) == 'S'){
                ...
                cp(newArrived + seq + '/video_h264.mp4', '/dump/dump200/cjfang/New_Sequence/' + title + '_h264_R.mp4');
                ...
                //
                //     cp('/dump/algo1/Supercam-yuv/' + title + '_h264_L.mp4', seqRoot + title + '/Front_Stereo/L/');
                //     cp('/dump/algo1/Supercam-yuv/' + title + '_h264_R.mp4', seqRoot + title + '/Front_Stereo/R/');
                //
                //
